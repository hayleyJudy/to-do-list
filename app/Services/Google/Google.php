...
class Google
{
    ...
    // In order to bring all of the power of the underlying client to our Google service, 
    // we proxy all method calls to that client through the magic method __call().
