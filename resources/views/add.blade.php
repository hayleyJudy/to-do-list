        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
            ...
            <form method="POST" action="/task">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="date" name="date" value="{{Carbon\Carbon::today()->format('Y-m-d')}}" class="bg-gray-100 rounded border border-gray-400 leading-normal h-10 py-1 px-2 font-medium placeholder-gray-700 focus:outline-none focus:bg-white">
                    @if ($errors->has('date'))
